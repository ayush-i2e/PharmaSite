        ...
        <>
            ...
            <main>
                <section className="hero">
                    <iframe src="https://my.spline.design/robotfollowcursorforlandingpage-9f106b3356a92dcc74818c539de79db7/" frameBorder="0" width="100%" height="100%"></iframe>
                    <div className="container">
                        <h2>Welcome To White Papers</h2>
                    </div>
                </section>
            </main>
            <footer>
          ...
          />
                            ...
                            <li>
                                <a href="https://www.linkedin.com/company/i2e-consulting/posts/?feedView=all"><i className="fab fa-linkedin-in icon"></i></a>
                            </li>
                            <li>
                                <a href="https://www.i2econsulting.com/"><i className="fab fa-google-plus-g icon"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
