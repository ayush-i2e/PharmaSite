                        ...
                        <div className="service-list">
                            <div className="card">
                                <div className="card-inner">
                                    ...
                                    <div className="card-back">
                                        <p>
                                            Expert consulting services to guide your pharmaceutical
                            ...
                            <div className="card">
                                <div className="card-inner">
                                    ...
                                    <div className="card-back">
                                        <p>
                                            Providing innovative technology solutions tailored for the
                            ...
                            <div className="card">
                                <div className="card-inner">
                                    ...
                                    <div className="card-back">
                                        <p>
                                            Developing custom software applications to address your
                            ...
                            <div className="card">
                                <div className="card-inner">
                                    ...
                                    <div className="card-back">
                                        <p>
                                            Reliable support and maintenance services to ensure smooth
                                            operation of your pharmaceutical systems.
                                        </p>
                                    </div>
                                </div>
                            </div>
