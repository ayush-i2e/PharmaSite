...
export default function Planisware() {
    return (
        <>
            <Head>
            ...
            <main>
                <section className="hero">
                    <iframe src="https://my.spline.design/chips-070c7e881b871b55713b38993717cf20/" frameBorder="0" width="100%" height="100%"></iframe>
                    <div className="container">
                        <h2>Welcome To Planisware</h2>
                    </div>
                </section>
                <section className="planisware-options">
                    <div className="container">
                        <h2>Planisware Options</h2>
                        <ul>
                            <li><a href="#">Consulting</a></li>
                            <li><a href="#">Your Planisware Journey</a></li>
                            <li><a href="#">PPM analytics</a></li>
                            <li><a href="#">IT-PPM setup</a></li>
                            <li><a href="#">Upgrade testing</a></li>
